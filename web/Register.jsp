...
<div style="position: relative;top:-10px; background-color: #D5FDFF;width:100%;height: 600px;background-size:cover;background:url('img/b2.jpg') no-repeat center center;">
    <div id="kuang">
        ...
        <form method="post"action="${pageContext.request.contextPath}/user" >
            ...
            <input  id="username"  type="text" name="username" placeholder="请输入用户名" required onfocus="a(this)" onblur="existname(this)">
            <br>
            <div id="namealreadyexist">该用户名已存在！</div>
            <%--<span class="glyphicon glyphicon-lock" style="position: relative;top:135px;left:80px;"></span>--%>
            <input  id="psw" type="password" name="password" placeholder="请输入密码" required onfocus="a(this)" onblur="b(this)">
            <br>
            <span class="glyphicon glyphicon-lock" style="position: relative;top:170px;left:80px;"></span>
            <input  id="psw1" type="password" name="passwordagain" placeholder="请再次输入密码" required onfocus="a(this)" onblur="samepasssword(this)">
            ...
            <input  id="name"  type="text" name="name" placeholder="请输入姓名" style="width: 270px;height:30px" required onfocus="a(this)" onblur="b(this)">
            <br>
            <span id="chioce">性别：
            ...
            <div>
                <input id=date type="date" name="date" placeholder="请输入生日 格式为年-月-日" required onfocus="a(this)" onblur="b(this)">
                <br>
            </div>
