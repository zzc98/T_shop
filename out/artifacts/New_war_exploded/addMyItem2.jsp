...
<div id="wodeshangpinkuang" style="border-radius: 3px;width:1280px;height:900px">
    ...
    <form id="addmyitemform" name="addmyitemform" action="${pageContext.request.contextPath}/addProduct" method="post"
        ...
        <img src="img/u179.png" style="position: relative;top:50px;left:50px;height:200px;width: 200px"
             id="consignerRdSign">
        ...
        <input required id="lianxifangshi" name="pname" value="" type="text"
               style="position: relative;left: 150px;top:50px;height: 30px;width: 323px;border-radius: 3px;border: 1px solid #CCCCCC;color:#333333;font-size: 13px;font-family: 微软雅黑">
        <br>
        ...
        <input required id="shangpinmingzi" name="pdesc" type="text"
               style="position: relative;left: 150px;top:110px;height: 30px;width: 323px;border-radius: 3px;border: 1px solid #CCCCCC;color:#333333;font-size: 13px;font-family: 微软雅黑">
        <br>
        <span style="position: relative;left: 150px;top:140px;font-family: 微软雅黑;font-size: 14px;color:#666666"> &nbsp &nbsp市场价：</span>
        <input required id="shichangjia" type="number" min="0" name="market_price" value=""
               style="position: relative;top:140px;;left: 150px;height: 23px;width: 57px;border-radius: 3px;border: 1px solid #CCCCCC;color:#333333;font-size: 13px;font-family: 微软雅黑">
        ...
        <input required name="shangchengjia" name="shop_price" type="number" min="0"
               style="position: relative;top:170px;;left: 150px;height: 23px;width: 57px;border-radius: 3px;border: 1px solid #CCCCCC;color:#333333;font-size: 13px;font-family: 微软雅黑">
        ...
        <select required id="fenlei" name="cid"
                style="position: relative;left: 150px;top:200px;height: 40px;width: 220px;font-family: 微软雅黑;font-size: 13px;border: 1px solid #CCCCCC">

        </select>
        <span style="font-family: 微软雅黑;position: relative;left: 200px;top:200px;font-size: 14px;color:#666666"> 商品数量：</span>
        <input required id="shangpinshuliang" name="shangpinshuliang" type="number" min="1"
               style="height: 23px;width: 57px;position:relative;top:200px;left:200px;border-radius: 3px;border: 1px solid #CCCCCC;color:#333333;font-size: 13px;font-family: 微软雅黑">
        <br>
        <button id="tijiao" onclick="a()"
                style="position: relative;top:250px;left:300px;height:50px;width:200px;background-color: #0a6cd6">提交商品
        </button>
