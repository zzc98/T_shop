		...
		<div style="text-align: center;">
			<ul class="pagination">
				<c:if test="${page.currentPage != 1 }">
					<li><a href="${pageContext.request.contextPath }/adminProduct?method=page&curPage=${page.currentPage - 1}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
				</c:if>
				...
				<c:if test="${page.currentPage != page.totalPage }">
					<li>
						<a href="${pageContext.request.contextPath }/adminProduct?method=page&curPage=${page.currentPage + 1}" aria-label="Next">
