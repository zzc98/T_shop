...
<div style="position:absolute;top:120px;left:200px;width:1100px;height:450px;">
		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<%--商品照片--%>
					<img src="${pageContext.request.contextPath}/${product.pimage}" style="width: 400px;height: 400px;position: relative;left: 30px;top:20px">
	...
	<div style="width:500px;height:400px;position: absolute;top: 0;left: 600px;margin:5px;">
		...
		<div style="height: 20%;width: 100%;">
			<span style="font-size: 13px;color: #333333">市场价：</span><span style="font-size: 14px;color: #333333">¥${product.market_price}</span><br>
			<span style="font-size: 14px;color: #333333">商城价：</span><span style="font-size:36px;color: red">¥${product.shop_price}</span>
		</div>
