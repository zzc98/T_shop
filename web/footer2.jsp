        ...
        <div class="auto clearfix">
            ...
            <div class="five-superiority">
                <ul class="five-superiority-list clearfix">
                    <li class="compensate_ico" style="opacity: 0;">
                        <a href="#compensate">
                            <span class="superiority-icon"></span>
                            <span>100倍故障赔偿</span>
                        </a>
                    </li>
                    <li class="retreat_ico" style="opacity: 0;">
                        <a href="#refund">
                            <span class="superiority-icon"></span>
                            <span>5天无理由退款</span>
                        </a>
                    </li>
                    <li class="technology_ico" style="opacity: 0;">
                ...
                <div class="footer-right">
                    ...
                    <div class="official-plat">
                        ...
                        <ul style="position: relative;left:150px">
                            ...
                            <li title="点击打开官方客服">
                                <a href="#"><span class="qq-logo"></span>某公司官方客服</a>
                            </li>
                        </ul>
                    </div>
                </div>
