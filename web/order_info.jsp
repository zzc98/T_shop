    ...
    <div style="background-color: white;width:1280px;margin: 0 auto;position: relative;">
        <%--收货信息--%>
            <div style="background-color: white;height:250px;margin: 0 auto;position: relative;padding-left: 10px;">
                ...
                <p style="font-family: 微软雅黑;font-size: 14px;color: #666666">收获地址
                    <input type="text" class="dingdan" name="address" onfocus="shuru(this)" onblur="shuruwan(this)" form="tijiaodingdanbiaodan">
                </p>
                <p style="font-family: 微软雅黑;font-size: 14px;color: #666666">联系方式
                    <input type="text" class="dingdan" name="telephone" onfocus="shuru(this)" onblur="shuruwan(this)" form="tijiaodingdanbiaodan">
                </p>
                <p style="font-family: 微软雅黑;font-size: 14px;color: #666666">联系人&nbsp&nbsp&nbsp
                    <input type="text" class="dingdan" name="name" onfocus="shuru(this)" onblur="shuruwan(this)" form="tijiaodingdanbiaodan">
                </p>
        ...
        <%--订单详情--%>
            ...
            <div style="height: 150px;margin: 0 auto;background-color: white">
                <img src="${pageContext.request.contextPath}/${item.product.pimage}" width="120" height="120" style="position: relative;top:30px;left:130px">
        ...
        <%--应付总额--%>
            <div style="height:80px;position: relative;top:-30px">
                <p style="position: relative;left: 1000px">
                    ...
                    <span style="font-size: 36px;color: #EA4242">${order.getTotal()}</span>
                </p>
            </div>
        <%--去结算--%>
